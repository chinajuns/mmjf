package com.ysjr.mmjf.module.login_module.protocol;
...
public class ProtocolActivity extends TopBarBaseActivity {
  ...
  @Override protected void init(Bundle savedInstanceState) {
    ...
    webView.loadUrl("http://h5.kuanjiedai.com/logup-arg.html");
